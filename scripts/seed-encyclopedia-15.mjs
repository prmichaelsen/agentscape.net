// One-shot seed: encyclopedia entry #15 (RFC).
...
const ENTRIES = [
  {
    ...
    title: "RFC",
    entry_number: 15,
    draft: `${DRAFT_BASE}/15-rfc.md`,
    related: ["mcp", "permission", "attestation", "autonomy"],
  },
];
...
writeFileSync("/tmp/seed-enc-15.sql", stmts.join("\n\n") + "\n");
console.log(`Wrote ${stmts.length} SQL stmts → /tmp/seed-enc-15.sql`);
